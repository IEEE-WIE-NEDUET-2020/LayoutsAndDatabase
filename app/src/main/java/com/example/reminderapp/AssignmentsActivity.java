...
public class AssignmentsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       mTextview.setVisibility(View.GONE);
        ...
        assignmentList = (ListView) findViewById(R.id.listViewsub1Test);
...
//            tv.setGravity(Gravity.CENTER);
        ...
        assignmentList.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                showDialog(temp2, assign.getSubject(), assign.getTopic(), assign.getDate());
        ...
        assignmentList.setChoiceMode(ListView.CHOICE_MODE_MULTIPLE_MODAL);
        assignmentList.setMultiChoiceModeListener(new  AbsListView.MultiChoiceModeListener() {
            ...
            public boolean onActionItemClicked(final ActionMode mode, MenuItem item) {
                ...
                switch  (item.getItemId()) {
                    ...
                    case R.id.selectAll:
                        ...
                        final int checkedCount  = assign_list.size();
                        adapter.removeSelection();
                        for (int i = 0; i <  checkedCount; i++) {

                            assignmentList.setItemChecked(i,   true);
                        }
...
//
                                        ...
                                        Assignment selecteditem = adapter.getItem(selected.keyAt(i));
                                        String assignId = selecteditem.getId();
                                        DatabaseReference newReference = FirebaseDatabase.getInstance().getReference("assignments").child(assignId);
...
//
            ...
            public void  onItemCheckedStateChanged(ActionMode mode, int position, long id, boolean checked) {
                final int checkedCount  = assignmentList.getCheckedItemCount();
                mode.setTitle(checkedCount  + "  Selected");
    ...
    protected void onStart() {
        ...
        myDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                assign_list.clear();
                str.clear();
                for(DataSnapshot assign_snapshot : dataSnapshot.getChildren()){
                    Assignment assignment = assign_snapshot.getValue(Assignment.class);
                    assign_list.add(assignment);

                    String firstLetter = assign_snapshot.child("subject").getValue(String.class);
                    str.add(firstLetter);
                ...
                if (assign_list.size()==0){
                    ...
                    Collections.reverse(assign_list);
                    ...
                    adapter = new AssignmentAdapter(AssignmentsActivity.this, assign_list, imgname);
                    assignmentList.setAdapter(adapter);
                    assignmentList.setLongClickable(true);
    ...
    public void openDialog(){
        AssignmentDialog exampleDialog = new AssignmentDialog();
        exampleDialog.show(getSupportFragmentManager(), "open");

    }

    public void showDialog( String temp, String subjectName, String topicName, String date){
        ...
        final View view = inflater.inflate(R.layout.display_dialog, null);
...
//        alertDialog.getWindow().setGravity(Gravity.CENTER);
    ...
    public void delTest(final String testId){
        DatabaseReference newReference = FirebaseDatabase.getInstance().getReference("assignments").child(testId);
        newReference.removeValue();
